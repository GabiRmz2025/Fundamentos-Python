# -*- coding: utf-8 -*-
"""Gabi-U2_Python.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/17_yP9vWPMIWYr8DngpKpUniACg9Qssmn
...
# definimos "a" una entrada con input es string con float lo convertimos a número tipo flotante
# a="10" después del float es a=10.0
x = -b/a
...
#Segundo ejemplo, con la caracterítica de robustez al agregar un else para atender 1 error
a = float (input("Valor de a:"))
b = float (input("Valor de b:"))
...
if a != 0:
  ...
  if b != 0:
      ...
      print("La ecuación tienen infinitas soluciones")
      # revisar por qué no sale cuándo a tiene valor y b es 0
...
if a != 0:
  ...
  if a == 0:
    if b != 0:
      print("La ecución no tiene solución")
    if b == 0:
      print("La ecuación tienen infinitas soluciones")
  # revisar por qué no sale cuándo a tiene valor y b es 0
...
grados_usuario = int(input("Grados máximos:"))
grados = 30
resultado = "Enciende AA" if grados >= grados_usuario else "No enciendes AA"
print(resultado)
...
#El for es un objeto iterable, es indexado
...
print(isinstance ("Hola", Iterable))
...
print("La lista es Iterbale? R=", isinstance(lista, Iterable))
print("La cadena es Iterbale? R=", isinstance(cadena, Iterable))
print("El número es Iterbale? R=", isinstance(numero, Iterable))
print("El conjunto es Iterbale? R=", isinstance(conjunto, Iterable))
...
matriz = ([20, 30, 5], [8, 69, 30], [9, 4, 3], "Hola")
print(matriz)
...
while x < 6:
    ...
    print("Fin de Ciclo")
    #Observa: el print esta dentro del while se repite "Fin de ciclo"
...
print("Fin de Ciclo")
 #Observa: el print esta fuera del while no se repite "Fin de ciclo"
...
x = 6
while x > 0: print(f"Valor de contador {x}"); x -= 1
...
while x:
  x.pop(0)
  print(x)
  # el pop saca el elemento que le indico de la lista,
  #lo hace hasta que concluye el ciclo
...
for letra in cadena:
  if letra == "h":
    ...
    break
    #break termina el ciclo cuando se cumple la indicación
  print(letra)
...
for letra in cadena:
  if letra == "h":
    print("Se encontro la h")
    # no hay berak no se debe detener hasta que termine la cadena
  print(letra)
...
for letra in cadena:
  if letra == "t":
    continue
    #sirve para saltar la condición que se cumple
  print(letra)
